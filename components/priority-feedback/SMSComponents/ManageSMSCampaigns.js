...
const ManageSMSCampaigns = ({ campaigns, onRefresh }) => {
  if (campaigns.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="text-6xl mb-4">📭</div>
        <p className="text-gray-600 mb-4">No SMS campaigns created yet.</p>
            ...
            <div className="flex items-start justify-between mb-3">
              <div>
                ...
                <p className="text-sm text-gray-600 mb-2">
                  <span className="font-semibold">Type:</span> {campaign.message_type} | <span className="font-semibold">Tone:</span> {campaign.tone}
                </p>
                <p className="text-sm text-gray-600 mb-2">
