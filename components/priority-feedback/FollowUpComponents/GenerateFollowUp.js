...
import { getCampaignContacts, generateFollowUpEmail } from '../../../utils/priority-feedback-api';

const GenerateFollowUp = ({ campaigns, apiKey }) => {
    ...
    <div className="space-y-6">
      ...
      {campaigns.length === 0 && (
        <div className="p-4 bg-yellow-50 text-yellow-800 rounded-lg border border-yellow-200">
          ...
          <p className="text-sm mt-1">Please create a campaign and add contacts first.</p>
        </div>
      )}
