  ...
  const features = [
    {
      ...
      link: '/email-analysis', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
    ...
    },
    {
      ...
      link: '/follow-up-analytics', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
    ...
    },
    {
      ...
      link: '/meeting-intent', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
    ...
    },
    {
      ...
      link: '/priority-feedback', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
    ...
    },
    {
      ...
      link: '/smart-quick-reply', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
    ...
    },
    {
      ...
      link: '/feedback-followup', // Internal Next.js route
      isInternal: true, // Flag to indicate internal route
            ...
            <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
              <div className="flex flex-col items-center justify-center space-y-2">
                ...
                {feature.isInternal ? (
                  <Link
                    href={feature.link}
                    className="mx-auto hover:underline gradient text-white font-bold rounded-full my-2 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out inline-block text-center"
                  >
                    Launch App
                  </Link>
                ) : (
                ...
                {feature.isInternal && (
                  <p className="text-xs text-green-600 text-center mt-2 px-2">
